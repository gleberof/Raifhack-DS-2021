...
def floor_processing(floor_feature):
    ...
    floor_features.columns = [
        'floor_is_nan' ,'floor_is_podval', 'floor_is_tsokol',
        'floor_is_antresol', 'floor_is_mansarda', 'floor_is_teknicheskii',
        'floor_is_floor', 'floor_number',
        'floor_is_first_floor', 'floor_is_second_floor', 'floor_is_third_floor'
    ]
